...
public class Target_C5 : MonoBehaviour
{
    private Rigidbody rb;
    private GameManager_C5 gameManager_C5;
    ...
    void Start()
    {
        ...
        gameManager_C5 = GameObject.Find("Game Manager").GetComponent<GameManager_C5>();
    ...
    {
        if (gameManager_C5.isGameActive)
        {
            Destroy(gameObject);
            gameManager_C5.UpdateScore(pointValue);
            Explode();
        }
